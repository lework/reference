...
- Clone Repository [View on Github](https://github.com/lework/reference.git)
    ```shell script {.wrap}
    $ git clone https://github.com/lework/reference.git
    ```
...
It's a good practice to refer to the source code of the [QuickRef cheatsheet](https://github.com/lework/reference/blob/main/source/_posts/quickref.md).
